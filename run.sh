...
bower install --config.storage.packages=$BOWER_STORAGE__CACHE/.bower-cache --config.storage.registry=$BOWER_STORAGE__CACHE/.bower-registry --config.tmp=$BOWER_STORAGE__CACHE/.bower-tmp 
